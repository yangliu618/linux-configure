...
(function(window) {
    ...
    var APFRequire = function(urls, type, callback) {
        this.urls = Object.prototype.toString.call(urls) === "[object Array]"  ? urls : [];
        this.type = type === 'js' ? 'js' : 'css';
        this.callback = typeof callback === 'function' ? callback : function() {};
        this.head = document.getElementsByTagName('head')[0];
        var self = this;
        window.basket.require.apply(window.basket, this.urls).then(function(res) {
            self.resolve.call(self, res);
        }, function(e) {
    ...
    APFRequire.prototype = {
        ...
        resolve : function(res) {
            ...
            for(k in res) {
                ...
                this.type === 'js' ? this.createTextScript(res[k]) : this.createTextStyle(res[k]);
            }
            this.callback();
        },
        reject : function() {
        ...
        createTextScript : function(text) {
            var script = document.createElement('script');
            script.type = "text/javascript";
